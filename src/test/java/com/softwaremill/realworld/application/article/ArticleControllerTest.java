...
class ArticleControllerTest {
    ...
    void getSingleArticles() throws Exception {
        mockMvc.perform(get("/api/articles/{slug}", "effective-java"))
                ...
                .andExpect(jsonPath("$.article.tagList").value("java"))
                .andDo(print());
    }
    ...
    void createArticle() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.article.tagList").value(new JSONArray().appendElement("sample").appendElement("test")))
                .andExpect(jsonPath("$.article.author.username").value("james"))
                .andDo(print());
    }
    ...
    public void updateArticle() throws Exception {
        ...
        CreateArticleRequest createRequest =
                new CreateArticleRequest("Test Article", "Test description", "Test body", List.of("test"));
